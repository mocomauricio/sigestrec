"""
Django settings for sigestrec project.
...
SECRET_KEY = '7)n!dgpgen+$4w*2a_%zlbeu&*crt^%(c*-785gmi6fn3#3e!('
...
WSGI_APPLICATION = 'sigestrec.wsgi.application'
